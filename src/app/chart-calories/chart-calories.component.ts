...
@Component({
  selector: 'app-chart-calories',
  templateUrl: './chart-calories.component.html',
  styleUrls: ['./chart-calories.component.css']
})
export class ChartCaloriesComponent implements OnInit {
